...
def fetch_mtsamples():
    ...
    print(f"Saving {num_samples} realistic patient medical transcripts to '{DATA_DIR}' directory...")
    ...
    print(f"Successfully replaced dummy data with {saved_count} high-end clinical notes!")
